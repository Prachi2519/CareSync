...
type Appointment = { id:string; startTime:string; endTime:string; status:string; symptoms:string; preVisitSummary?:string; urgency:string; suggestedQuestions?:string; postVisitNotes?:string; postVisitSummary?:string; patient:{name:string;email:string;phone?:string}; doctor:{specialization:string;user:{name:string}} };
